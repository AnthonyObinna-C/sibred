...
function validateForm() {
    ...
    var number = document.forms["myForm"]["subject"].value;
    ...
    xhttp.open("POST", "contact/contact.php", true);
    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xhttp.send("name=" + name + "&email=" + email + "&number=" + number + subject +"&subject" + "&comments=" + comments);
    return false;
}
